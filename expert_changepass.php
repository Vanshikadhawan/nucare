...
?>
   ...
   function decrypt($string)
    ...
    { 
        ...
        {
         $sql= "SELECT * FROM tab_expert_advisor where login_id='".$_SESSION['eid']."'";
              ...
              if($row = mysqli_fetch_array($result))
                {
                   ...
                   if($oldpass==decrypt($row['password']))
                   {
                        if ($newpass==$conpass)
                        {
                          ...
                          $sqpupdate="update tab_expert_advisor set password='$newpass' where login_id='".$_SESSION['eid']."'";
            ...
            <div class="col-sm-6">
                <div class="border border-dark p-4 sm-6 style">
                    <form id="f1" name="f1" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-primary col-sm-6 s1 s2" name="btn1" style="height: 110%;width:40%; margin-left: 140px;">Change</button>
                            </div>
                        </div>  
                    </form> 
                </div>
