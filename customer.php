...
echo $sqllogin="SELECT * FROM tab_customer where login_id='".$id."'";
    ...
    if($rowcount==0)
    {
            	...
            	$sql="INSERT INTO tab_customer(customer_name,login_id,password,gender,mobile_number,creation_date)	Values('$varname', '$varloginid' ,
              '$varpass', '$vargender', '$varmob','$dt')";
...
<div class="row">
	...
	<div class="col-sm-4 one"> <h2>CUSTOMER LOGIN</h2></div>
	<div class="col-sm-4"></div>
</div>
</br></br>
