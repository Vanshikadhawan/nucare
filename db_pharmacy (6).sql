...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 12, 2021 at 09:06 AM
...
(1, '6', 'vanshikadhawan99211@gmail.com', '1', 'ordered', '2021-07-12 00:00:00'),
(2, '6', 'vanshikadhawan99211@gmail.com', '1', 'ordered', '2021-07-12 00:00:00'),
(3, '6', 'vanshikadhawan99211@gmail.com', '1', 'ordered', '2021-07-12 00:00:00'),
(4, '4', 'vanshikadhawan99211@gmail.com', '1', 'ordered', '2021-07-12 00:00:00');
...
(1, '', '2021-07-12', '885', 'In process', '2021-07-12'),
(2, '', '2021-07-12', '885', 'In process', '2021-07-12'),
(3, 'vanshikadhawan99211@gmail.com', '2021-07-12', '885', 'In process', '2021-07-12');
...
(1, '3', '6', NULL, '1', 'In process', '2021-07-12'),
(2, '3', '6', NULL, '1', 'In process', '2021-07-12'),
(3, '3', '6', NULL, '1', 'In process', '2021-07-12'),
(4, '3', '4', NULL, '1', 'In process', '2021-07-12');
...
(7, 'Tri-active', 'images/tri_activ_instant_hand_sanitizer_500_ml_1_1.jpg', 4, 1, '2021-07-12 08:00:20'),
(14, 'DEmo1', 'images/1mile_disposable_3_ply_face_mask_white_100_s_0.jpg', 6, 1, '2021-07-12 08:15:14'),
(15, 'DEmo2', 'images/1mile_protective_face_shield_be_alert_400_micron_10s_2_0.jpg', 6, 1, '2021-07-12 08:15:24');
...
ALTER TABLE `tab_product`
  ...
  ADD KEY `fk_parent` (`parent_category`);
...
--
ALTER TABLE `tab_product`
  ADD CONSTRAINT `fk_parent` FOREIGN KEY (`parent_category`) REFERENCES `tab_category` (`category_id`);

--
-- Constraints for table `tab_product_image`
--
ALTER TABLE `tab_product_image`
  ADD CONSTRAINT `fk_prodid` FOREIGN KEY (`product_id`) REFERENCES `tab_product` (`product_id`);
COMMIT;
