...
echo $sqllogin="SELECT * FROM tab_pharmacist where login_id='".$id."'";
    ...
    if($rowcount==0)
    {
            	...
            	$sql="INSERT INTO tab_pharmacist(pharmacist_name,login_id,password,creation_date)	Values('$varname', '$varloginid' ,
              '$varpass','$dt')";
...
?>
	...
	<div class="privacy py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2 bg">
...
<div class="row">
	...
	<div class="col-sm-8 one"> <h2>PHARMACIST LOGIN</h2></div>
	<div class="col-sm-2"></div>
</div>
</br></br>
<div class="form-group">
    ...
    <small id="uidhelp" class="form-text text-muted" required="required">Please Provide Your Valid Email Id, As your password will be send on it Eg : abc@xyz.com </small>
    </div>
     <div class="form-group">
