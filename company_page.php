		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
						...
						include 'connection.php';
							...
							$varoffid="1";
										...
										if(isset($_GET['comid']) )
										{
											...
											$sqlview="SELECT * FROM tab_company where company_id=$varcomid";
											}
											else
											$sqlview="SELECT * FROM tab_company where company_id=5 ";
				...
				echo'<div class="col-lg-5 col-md-8 single-right-left ">
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="'.$row['company_logo'].'">
									<div class="thumb-image">
										<img src="'.$row['company_logo'].'" width=100px height=100px alt=""> </div>
								</li>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3">'.$row['company_name'].'</h3>
